  ...
  render() {
    return(
      ...
      <section className="container shop-section">
        <div className="row">
        <div className="col-6">
        <button type="button" class="btn btn-secondary btn-lg btn-block" id="pickup-btn">PICKUP IN STORE</button> 
...
class Crousel extends Component{
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block" src={require("./mixer.png")} alt="First slide"/>
    </div>
    <div class="carousel-item">
      <img class="d-block" src={require("./mixer.png")} alt="Second slide"/>
    </div>
    <div class="carousel-item">
      <img class="d-block" src={require("./mixer.png")} alt="Third slide"/>
    </div>
  </div>
